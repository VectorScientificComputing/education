...
```console
[u100490@login02 ~]$ cd /project/home/p201351
[u100490@login02 p201351]$ pwd
/project/home/p201351
```
...
```console
[u100490@login02 p201351]$ mkdir ${USER}
```

Now move into the working directory. For example, for user `u100490`:

```console
[u100490@login02 p201351]$ cd u100490
```
...
```console
[u100490@login03 u100490]$ cp -r /project/home/p201351/OpenACC .
[u100490@login03 u100490]$ cd OpenACC/
[u100490@login03 OpenACC]$ pwd
/project/home/p201351/u100490/OpenACC
[u100490@login03 OpenACC]$ ls -lthr
total 20K
-rw-r-----. 1 u100490 p201351   51 Mar 13 15:50 module.sh
drwxr-s---. 2 u100490 p201351 4.0K Mar 13 15:50 Vector-addition
drwxr-s---. 2 u100490 p201351 4.0K Mar 13 15:50 Unified-memory
...
...
```
...
[u100490@mel2131 ~]$ squeue -u u100490
           ...
           304381       gpu interact  u100490    p201351  RUNNING       0:37     01:00:00      1 mel2131
```
